...
counter = 1
for(i in seq_len(nrow(volcano) - 1)) {
  for(j in seq_len(ncol(volcano) - 1)) {
...
image(x=seq_len(nrow(volcano)), y = seq_len(ncol(volcano)), volcano)
